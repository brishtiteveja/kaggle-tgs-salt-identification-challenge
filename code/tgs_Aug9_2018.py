...
model_checkpoint = ModelCheckpoint("./keras-augment-fine-strat-8Aug2018.model", save_best_only=True, verbose=1)
...
model_dir = '../working/'
model = load_model(model_dir + "keras-augment-fine-strat-8Aug2018.model")
